...
type Event struct {
	...
	Type      string    `json:"type"` // user_message, llm_request, llm_response, llm_delta, tool_call, tool_result, patch, command, approval, agent_message, agent_finished, context_compacted, error
